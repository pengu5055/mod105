"""
This script solves the rate equations for the stationary case.
"""
import numpy as np
import pandas as pd
...
from hydrogenfusion import HydrogenFusionStationaryH
from helper import *
...
hf = HydrogenFusionStationaryH(init_conc, t_eval, rates)
