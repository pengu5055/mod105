...
sol_Br.y = sol_Br.y / np.sum(init_conc)
...
mod2_H2 = ax[1].plot(sol_Br.t, sol_Br.y[0], color=colors_Br[0], linestyle='--')
mod2_Br2 = ax[1].plot(sol_Br.t, sol_Br.y[1], color=colors_Br[1], linestyle=':')
mod2_HBr = ax[1].plot(sol_Br.t, sol_Br.y[2], color=colors_Br[2])
mod2_H = ax[1].plot(sol_Br.t, sol_Br.y[3], color=colors_Br[3], linestyle=(0, (5, 10)))
mod2_Br = ax[1].plot(sol_Br.t, sol_Br.y[4], color=colors_Br[4], linestyle=(0, (3, 10, 1, 10, 1, 10)))
mod2_sum = ax[1].plot(sol_Br.t, np.sum(sol_Br.y, axis=0), color=colors_Br[5], linestyle='-', lw=1)

mod3_H2 = ax[2].plot(sol_H.t, sol_H.y[0], color=colors_H[0], linestyle='--')
mod3_Br2 = ax[2].plot(sol_H.t, sol_H.y[1], color=colors_H[1], linestyle=':')
mod3_HBr = ax[2].plot(sol_H.t, sol_H.y[2], color=colors_H[2])
mod3_H = ax[2].plot(sol_H.t, sol_H.y[3], color=colors_H[3], linestyle=(0, (5, 10)))
mod3_Br = ax[2].plot(sol_H.t, sol_H.y[4], color=colors_H[4], linestyle=(0, (3, 10, 1, 10, 1, 10)))
mod3_sum = ax[2].plot(sol_H.t, np.sum(sol_H.y, axis=0), color=colors_H[5], linestyle='-', lw=1)

for x in ax:
    x.grid(color='#424656', alpha=0.1)
    x.hlines(1, 0, 10, color='#424656', linestyle='--')
